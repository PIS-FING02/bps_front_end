...
public class PuestoFacade {
	...
	public static final String URL_GET_METRICAS_PUESTOS = SERVER + UtilService.getStringProperty("URL_GET_METRICAS_PUESTOS");
	public static final String URL_REST_PUESTO_FULL = SERVER + UtilService.getStringProperty("URL_REST_FULL");
	public static final String URL_GET_PUESTO_ALL = SERVER + UtilService.getStringProperty("URL_GET_PUESTO_ALL");
	public static final String URL_GET_ALL_PUESTO_SECTOR = SERVER + UtilService.getStringProperty("URL_GET_ALL_SECTOR");
	public static final String URL_ASIG_TRAMITE = SERVER + UtilService.getStringProperty("URL_ASIG_TRAMITE");
	public static final String URL_TRAMITES_ASIGNABLES = SERVER + UtilService.getStringProperty("URL_TRAMITES_ASIGNABLES");
	public static final String URL_DESASIG_TRAMITE = SERVER + UtilService.getStringProperty("URL_DESASIG_TRAMITE");
	public static final String URL_PUESTOS_SECTOR = SERVER + UtilService.getStringProperty("URL_PUESTOS_SECTOR");
