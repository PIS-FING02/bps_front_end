...
public class SectorBean {
	...
	public String asignarTramiteSector() throws Exception {
		...
		shared.updateNotice(status, "El tr�mite con c�digo "+ this.codigo + " se asign� correctamente al sector con c�digo " + this.id + ".");
	...
	public String asignarDisplaySector() throws Exception {
		...
		shared.updateNotice(status, "El display con identificador "+ this.displayId + " se asign� correctamente al sector con c�digo " + this.id + ".");
		return "/pages/sectores.xhtml?busqueda=false&faces-redirect=true";
	}
	...
	public String asignarPuestoSector() throws Exception {
		...
		shared.updateNotice(status, "El puesto con nombre de m�quina "+ this.nombreMaquina + " se asign� correctamente al sector con c�digo " + this.id + ".");
		return "/pages/sectores.xhtml?busqueda=false&faces-redirect=true";
	}
	...
	public String desasignarTramiteSector() {
		...
		shared.updateNotice(status, "El tr�mite con c�digo "+ this.codigo + " se desasign� correctamente del sector con c�digo " + this.id + ".");
		return "/pages/sectores.xhtml?busqueda=false&faces-redirect=true";
	}
	...
	public String desasignarDisplaySector() {
		...
		shared.updateNotice(status, "El display con identificador "+ this.displayId + " se desasign� correctamente del sector con c�digo " + this.id + ".");
		return "/pages/sectores.xhtml?busqueda=false&faces-redirect=true";
	}
	...
	public String desasignarPuestoSector() {
		...
		shared.updateNotice(status, "El puesto con nombre de m�quina "+ this.nombreMaquina + " se desasign� correctamente al sector con c�digo " + this.id + ".");
		return "/pages/sectores.xhtml?busqueda=false&faces-redirect=true";
	}
	...
	public List<JSONNumero> listarNumerosSector() {
		...
		if (idSector != null) {
			...
			if (list == null || list.isEmpty()) 
				shared.updateNoticeInfo("No se encontraron n�meros en el sistema para el sector con identificador " + idSector + " .");
			return list;
		} else
			return null;
	}
