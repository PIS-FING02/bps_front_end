...
public class PuestoBean {
	...
	public String llamarNumero() throws Exception {
		...
		if(num != null && !numNotFound.find()){
			...
			/*this.error_message = "No tienes nï¿½meros disponibles para llamar en este momento";
			this.error = "show";*/
			shared.updateNoticeInfo("No existe ningÃºn nÃºmero que pueda atender en este momento");
			return "/pages/operadorAbierto.xhtml?faces-redirect=true";
		}
	}
